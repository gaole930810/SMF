 ...
 */
public class GetFrameWithTimestampTest {
    public static final Log LOG = LogFactory.getLog(GetFrameWithTimestampTest.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //首先获取某一个视频的视频元数据对象
        String Path = "hdfs://vm1:9000/yty/video/774.rmvb";
